...
The overall number of students enrolled in college was down in 2021 compared to enrollment patterns prior to the pandemic. As indicated in the chart below, the number of students opting out of college (light blue) increases over time, while the number enrolled (darker blue) decreases over the same time period. Basically, a substantial number of students are opting out of college today compared to the past seven years.
